				...
				<div class="col-sm-9">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<p>
								Título Original : ${pelicula.titulo }  <br> Actores : James McAvoy, Anya
								Taylor Joy, Betty Buckley, Brad William Henke <br>
								Director: Night Shyamalan <br> Clasificación: ${pelicula.clasificacion } <br>
								Duración: ${pelicula.duracion }  <br> Género: ${pelicula.genero } <br> Fecha
