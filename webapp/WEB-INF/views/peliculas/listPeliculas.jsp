...
<html lang="en">
  ...
  <body>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <c:if test="${msnsaje != null }">
            <div class='alert alert-success' role="alert">${ msnsaje}</div>
      </c:if>
					...
					<tr>
						...
						<td> <fmt:formatDate value="${peli.fechaEstreno}" pattern="dd-MM-yyyy" /> </td>
						   ...
						   <c:choose>
						     ...
						     <c:when test="${peli.estatus eq 'Activa'}">
						         <td><span class="label label-success">${peli.estatus}</span></td>
						     </c:when>
						     
						     <c:otherwise>
							    <td><span class="label label-danger">${peli.estatus}</span></td>
						     </c:otherwise>
